...
namespace Teedy.ApiClient
{
    ...
    public class TeedyApiMethods
    {
        ...
        public static async Task<GetAllDocumentsResponse> GetDocuments(string authToken, int limit, int offset)
        {
            try
            {
                ...
                if (_restResponse.IsSuccessful && !string.IsNullOrEmpty(_restResponse.Content))
                {
                    ...
                    {
                        LogError("Failed to retrieve documents. " + _restResponse.ErrorMessage + _restResponse.Content);
            ...
            {
                LogError("Failed to retrieve documents. " + ex.Message );
        ...
        /// 
        /// </summary>
        public static async Task<string> UpdateDoc(string authToken, string documentId, string title, string description, List<string> tags)
        {
            try
            {
                ...
                _restRequest.AddParameter("description", description);
                ...
                {
                    throw new Exception("Failed to update documents. " + _restResponse.ErrorMessage);
                }
            }
            catch
            {
